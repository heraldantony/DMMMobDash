...
class Drawer extends Component {
	constructor(props) {
		...
		this._goToAccelChart = this._goToAccelChart.bind(this);
		this._goToFFTChart = this._goToFFTChart.bind(this);
	...
	_goToAccelChart() {
		...
		this.props.navigator.popToRoot({
			screen: 'dmmmobdash.AccelerationChart'
		});
	}
